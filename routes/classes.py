...
def add():
    ...
    giang_viens = execute_query(
        "SELECT id, ho_ten FROM admin WHERE role = 'giang_vien'"
    )
...
def detail(id):
    ...
    return render_template(
        "classes/detail.html", cls=cls, students=students, summary=summary
    )
...
def edit(id):
    ...
    return render_template(
        "classes/edit.html", cls=cls, schedules=schedules, giang_viens=giang_viens
    )
